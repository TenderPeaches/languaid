...
Word.create(language_id: 2, loc: "remedy", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
...
Word.create(language_id: 2, loc: "rose", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
...
Word.create(language_id: 2, loc: "pleasure", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
...
Word.create(language_id: 2, loc: "desire", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "deseo", word_definition: word_def, wordable: Noun.create({"gender_id"=>2}))

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "j'espère", word_definition: word_def, wordable: Expression.create({}))
Word.create(language_id: 2, loc: "I hope", word_definition: word_def, wordable: Expression.create({}))
Word.create(language_id: 3, loc: "ojalá", word_definition: word_def, wordable: Expression.create({}))

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "comment", word_definition: word_def)
Word.create(language_id: 2, loc: "how much", word_definition: word_def)
Word.create(language_id: 2, loc: "how many", word_definition: word_def)
Word.create(language_id: 3, loc: "cuanto", word_definition: word_def)

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "somme", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
Word.create(language_id: 2, loc: "sum", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "suma", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
WordDefinitionTag.create(word_definition: word_def, word_tag_id: 3)

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "différence", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
Word.create(language_id: 2, loc: "substraction", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "resta", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
WordDefinitionTag.create(word_definition: word_def, word_tag_id: 3)

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "multiplication", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
Word.create(language_id: 2, loc: "product", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "multiplicación", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
WordDefinitionTag.create(word_definition: word_def, word_tag_id: 3)

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "division", word_definition: word_def, wordable: Noun.create({"gender_id"=>2}))
Word.create(language_id: 2, loc: "division", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "división", word_definition: word_def, wordable: Noun.create({"gender_id"=>2}))
WordDefinitionTag.create(word_definition: word_def, word_tag_id: 3)

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "exposant", word_definition: word_def, wordable: Noun.create({"gender_id"=>2}))
Word.create(language_id: 2, loc: "exponent", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "exponente", word_definition: word_def, wordable: Noun.create({"gender_id"=>2}))
WordDefinitionTag.create(word_definition: word_def, word_tag_id: 3)

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "racine carrée", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
Word.create(language_id: 2, loc: "square root", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "raíz cuadrada", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
WordDefinitionTag.create(word_definition: word_def, word_tag_id: 3)

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "algèbre", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
Word.create(language_id: 2, loc: "algebra", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "álgebra", word_definition: word_def, wordable: Noun.create({"gender_id"=>3}))
WordDefinitionTag.create(word_definition: word_def, word_tag_id: 3)

word_def = WordDefinition.create({"definition"=>""})
Word.create(language_id: 1, loc: "produit", word_definition: word_def, wordable: Noun.create({"gender_id"=>2}))
Word.create(language_id: 2, loc: "product", word_definition: word_def, wordable: Noun.create({"gender_id"=>nil}))
Word.create(language_id: 3, loc: "producto", word_definition: word_def, wordable: Noun.create({"gender_id"=>2}))
WordDefinitionTag.create(word_definition: word_def, word_tag_id: 3)
