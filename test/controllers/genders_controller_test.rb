...
class GendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gender" do
    assert_difference("Gender.count") do
      post genders_url, params: { gender: { name: @gender.name, shorthand: @gender.shorthand } }
    end
  ...
  test "should update gender" do
    patch gender_url(@gender), params: { gender: { name: @gender.name, shorthand: @gender.shorthand } }
