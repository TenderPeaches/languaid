...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference("Language.count") do
      post languages_url, params: { language: { active: @language.active, name: @language.name, shorthand: @language.shorthand } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { active: @language.active, name: @language.name, shorthand: @language.shorthand } }
